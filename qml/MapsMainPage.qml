  ...
  NavigationStack {
    ...
    Page {
      ...
      AppMap {
        ...
        // Defaults to Origo, Barcelonas
        center: QtPositioning.coordinate(41.400709, 2.163111)
        zoomLevel: 14
        Component.onCompleted: {
          map.center = QtPositioning.coordinate(41.400709, 2.163111)
          map.zoomLevel = 14
        }
        ...
        MapItemView {
          ...
          delegate: MapQuickItem {
            coordinate: QtPositioning.coordinate(41.400709, 2.163111)
